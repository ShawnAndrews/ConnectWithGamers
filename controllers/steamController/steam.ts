...
routes.addRoute("stringaction", "/steam/genre/action");
routes.addRoute("stringadventure", "/steam/genre/adventure");
routes.addRoute("stringcasual", "/steam/genre/casual");
routes.addRoute("stringstrategy", "/steam/genre/strategy");
routes.addRoute("stringracing", "/steam/genre/racing");
routes.addRoute("stringsimulation", "/steam/genre/simulation");
routes.addRoute("stringsports", "/steam/genre/sports");
routes.addRoute("stringindie", "/steam/genre/indie");
routes.addRoute("string2d", "/steam/genre/2d");
routes.addRoute("stringpuzzle", "/steam/genre/puzzle");
routes.addRoute("stringshooter", "/steam/genre/shooter");
routes.addRoute("stringrts", "/steam/genre/rts");
routes.addRoute("stringtowerdefence", "/steam/genre/towerdefence");
...
/* action games */
router.post(routes.getRoute("stringaction"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* adventure games */
router.post(routes.getRoute("stringadventure"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* casual games */
router.post(routes.getRoute("stringcasual"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* strategy games */
router.post(routes.getRoute("stringstrategy"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* racing games */
router.post(routes.getRoute("stringracing"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* simulation games */
router.post(routes.getRoute("stringsimulation"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* sports games */
router.post(routes.getRoute("stringsports"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* indie games */
router.post(routes.getRoute("stringindie"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* 2d games */
router.post(routes.getRoute("string2d"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* puzzle games */
router.post(routes.getRoute("stringpuzzle"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* shooter games */
router.post(routes.getRoute("stringshooter"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* rts games */
router.post(routes.getRoute("stringrts"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
...
/* tower defence games */
router.post(routes.getRoute("stringtowerdefence"), (req: Request, res: Response) => {
    const genericResponse: GenericModelResponse = { error: undefined };
    const path: string = req.path;
