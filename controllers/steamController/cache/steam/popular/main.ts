 ...
 */
export function steamPopularExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamPopularGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamPopularGames(path: string): Promise<GameResponse[]> {
