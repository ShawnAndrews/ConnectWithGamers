 ...
 */
export function steamHorrorExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamHorrorGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamHorrorGames(path: string): Promise<GameResponse[]> {
