 ...
 */
export function steamCardsExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamCardsGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamCardsGames(path: string): Promise<GameResponse[]> {
