 ...
 */
export function steamRtsExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamRtsGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamRtsGames(path: string): Promise<GameResponse[]> {
