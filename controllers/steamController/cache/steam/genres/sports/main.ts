 ...
 */
export function steamSportsExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamSportsGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamSportsGames(path: string): Promise<GameResponse[]> {
