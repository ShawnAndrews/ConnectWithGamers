 ...
 */
export function steamSimulationExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamSimulationGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamSimulationGames(path: string): Promise<GameResponse[]> {
