 ...
 */
export function steamFreeOnlineMultiKeyExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamFreeOnlineMultiGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamFreeOnlineMultiGames(path: string): Promise<GameResponse[]> {
