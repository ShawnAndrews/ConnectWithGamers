 ...
 */
export function steamShooterExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamShooterGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamShooterGames(path: string): Promise<GameResponse[]> {
