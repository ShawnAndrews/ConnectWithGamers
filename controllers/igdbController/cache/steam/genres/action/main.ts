 ...
 */
export function steamActionExists(): Promise<boolean> {

    return new Promise((resolve: any, reject: any) => {
        igdbModel.resultsExists(ResultsEnum.SteamGenreAction)
            .then((exists: boolean) => {
 ...
 * Get cached games.
 */
export function getSteamActionGames(): Promise<GameResponse[]> {

    return new Promise((resolve: any, reject: any) => {
        igdbModel.getResults(ResultsEnum.SteamGenreAction)
            .then((gameIds: number[]) => {
 ...
 * Cache games.
 */
export function cacheSteamActionGames(): Promise<GameResponse[]> {
    ...
    return new Promise((resolve: any, reject: any) => {
        ...
        parseSteamIdsFromQuery(URL)
            .then((gamesResponse: GameResponse[]) => {
                ...
                igdbModel.setResults(ids, ResultsEnum.SteamGenreAction)
                    .then(() => {
