 ...
 */
export function steamRacingExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamRacingGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamRacingGames(path: string): Promise<GameResponse[]> {
