 ...
 */
export function steamCasualExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamCasualGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamCasualGames(path: string): Promise<GameResponse[]> {
