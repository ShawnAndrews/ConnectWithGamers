 ...
 */
export function steamTowerDefenceExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamTowerDefenceGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamTowerDefenceGames(path: string): Promise<GameResponse[]> {
