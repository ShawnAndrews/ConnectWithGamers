 ...
 */
export function steamPuzzleExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamPuzzleGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamPuzzleGames(path: string): Promise<GameResponse[]> {
