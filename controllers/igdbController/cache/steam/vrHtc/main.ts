 ...
 */
export function steamVrHtcKeyExists(): Promise<boolean> {

    return new Promise((resolve: any, reject: any) => {
        igdbModel.resultsExists(ResultsEnum.SteamVrHtc)
            .then((exists: boolean) => {
 ...
 * Get cached games.
 */
export function getSteamVrHtcGames(): Promise<GameResponse[]> {

    return new Promise((resolve: any, reject: any) => {
        igdbModel.getResults(ResultsEnum.SteamVrHtc)
            .then((gameIds: number[]) => {
 ...
 * Cache games.
 */
export function cacheSteamVrHtcGames(): Promise<GameResponse[]> {
    ...
    return new Promise((resolve: any, reject: any) => {
        ...
        parseSteamIdsFromQuery(URL)
            .then((gamesResponse: GameResponse[]) => {
                ...
                igdbModel.setResults(ids, ResultsEnum.SteamVrHtc)
                    .then(() => {
