 ...
 */
export function steamFPSExists(): Promise<boolean> {

    return new Promise((resolve: any, reject: any) => {
        igdbModel.resultsExists(ResultsEnum.SteamFPS)
            .then((exists: boolean) => {
 ...
 * Get cached games.
 */
export function getSteamFPSGames(): Promise<GameResponse[]> {

    return new Promise((resolve: any, reject: any) => {
        igdbModel.getResults(ResultsEnum.SteamFPS)
            .then((gameIds: number[]) => {
 ...
 * Cache games.
 */
export function cacheSteamFPSGames(): Promise<GameResponse[]> {
    ...
    return new Promise((resolve: any, reject: any) => {
        ...
        parseSteamIdsFromQuery(URL)
            .then((gamesResponse: GameResponse[]) => {
                ...
                igdbModel.setResults(ids, ResultsEnum.SteamFPS)
                    .then(() => {
