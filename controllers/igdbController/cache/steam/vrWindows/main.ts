 ...
 */
export function steamVrWindowsKeyExists(path: string): Promise<boolean> {
 ...
 * Get cached games.
 */
export function getSteamVrWindowsGames(path: string): Promise<GameResponse[]> {
 ...
 * Cache games.
 */
export function cacheSteamVrWindowsGames(path: string): Promise<GameResponse[]> {
